...
def main():
    ...
    output_file = Path(__file__).parent / "behavior_merged_kto_11.23.25.jsonl"
    ...
    for behavior in behaviors:
        file_path = behavior_datasets_dir / behavior / "pairs_v1.0.jsonl"
        if file_path.exists():
    ...
    print(f"Ready for KTO training")
