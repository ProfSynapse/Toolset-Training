...
Run from repo root:
    ...
    python cli.py train    # Training submenu
    python cli.py upload   # Upload submenu
    python cli.py eval     # Evaluation submenu
    python cli.py pipeline # Full pipeline (train -> upload -> eval)
"""
...
Examples:
  python cli.py           # Interactive mode
  python cli.py train     # Go directly to training
  python cli.py upload    # Go directly to upload
"""
    )
